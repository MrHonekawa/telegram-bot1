...
def start(update, context):
    ...
    update.effective_message.reply_text("Hi there, you need to be @Bhattuish to use this bot...\nIf u are, run /help to see available commands...",)
...
def send(update, context):
    user = update.message.from_user.username
    if user != "Bhattuish" and user != "test_trx_bot" :
            update.effective_message.reply_text(text="You are not the Master - @Bhattuish!!\nGo create your own bot....")
    else:
